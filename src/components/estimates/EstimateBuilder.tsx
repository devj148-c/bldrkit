...
export function EstimateBuilder({
  ...
  const [customerId, setCustomerId] = useState(estimate?.customerId || defaultCustomerId || "")
    ...
    <div className="max-w-4xl space-y-6">
      {estimate && (
        <div className="flex items-center gap-3">
          <Badge variant="secondary" className="text-sm">{estimate.status}</Badge>
        </div>
      )}
      ...
      <Card>
        ...
        <CardContent>
          <Textarea
            ...
            placeholder="Payment terms, warranty info, special instructions..."
            rows={3}
          />
        </CardContent>
      </Card>
      ...
      <div className="flex gap-3">
        <Button onClick={handleSave} disabled={saving || !customerId}>
          ...
          {saving ? "Saving..." : estimate ? "Update Estimate" : "Create Estimate"}
        </Button>
